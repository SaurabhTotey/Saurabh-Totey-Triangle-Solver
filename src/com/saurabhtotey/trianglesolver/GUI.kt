...
val screen = document.getElementById("screen") as HTMLCanvasElement ///The actual rendering area to draw the triangles
val renderer = screen.getContext("2d") as CanvasRenderingContext2D ///The object which draws to the screen
